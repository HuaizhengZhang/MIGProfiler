model_names=('vision_transformer' 'resnet50' 'swin_transformer')# the models to be tested
group_id=2 # the dcgm group if you are going to monitor
profile_ids=(0 9 14 19) # the profile id of the mig partition
dcgm_result_dir="save_dir=/root/A100-benchmark/data/train/cv/" # the gpu metric result are saved here
