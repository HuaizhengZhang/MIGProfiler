...
function batch_size_benchmark {
  ...
  do
      ...
      CUDA_VISIBLE_DEVICES=${profile_device[$1]} python A100-nlp-train_test.py \
...
do
  ...
  do
    ...
    python dcgm_recorder.py "group_id=${group_id}" "save_dir=/root/A100-benchmark/data/train/nlp/"&
    pid=$!
